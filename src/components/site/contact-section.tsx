...
export function ContactSection() {
  ...
  const channels = [
    ...
    { label: 'GitHub', value: 'heenaikramdekhan', href: social.github, icon: Github },
    { label: 'LinkedIn', value: 'heena', href: social.linkedin, icon: Linkedin },
    ...(social.liveProduct
      ? [
          {
            label: 'Live Product',
            value: social.liveProduct
              .replace(/^https?:\/\/(www\.)?/, '')
              .replace(/\/$/, ''),
  ...
  return (
    <Section
      ...
      index="06"
      title="Get in touch"
      description="Shipping an AI product and want someone who breaks it before your users do? Let's talk."
    >
      <Reveal>
