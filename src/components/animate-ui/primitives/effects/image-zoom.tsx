...
/*
 * Vendored from Animate UI (@animate-ui/primitives-effects-image-zoom).
 *
 * One deliberate change from upstream: the import is retargeted from
 * 'motion/react' to 'framer-motion'. They are the same library under two
 * package names, and this project already ships framer-motion v12, so
 * installing the registry dependency verbatim would have bundled a second
 * copy of the animation runtime. Re-run the diff against upstream if you
 * ever bump this file.
 */
